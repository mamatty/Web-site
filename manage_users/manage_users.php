...
?>
    ...
    <div class="main">
        ...
        <header>
            ...
            echo "<a href='create_user.php' class='btn btn-primary m-b-1em'>Create New User</a>";
            ?>
        <br>
        <br>
        ...
        <br>
            ...
            $query = "SELECT id_user, name, surname, email FROM user ORDER BY id_user DESC LIMIT $from_record_num,$records_per_page";
            ...
            if (mysqli_num_rows($result)){
                ...
                $statement = mysqli_prepare($mysqli,'SELECT * FROM user');
