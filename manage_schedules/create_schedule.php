 ...
 */
    ...
    if($_POST){
        try{
            ...
            $sql = $mysqli->prepare("INSERT INTO schedules (id_user,name,details,start_date,end_date,num_days,objective) VALUES (?,?,?,?,?,?,?)");
            $sql->bind_param("issssis",$id,$name,$detail,$start_date,$end_date,$num_days,$objective);
