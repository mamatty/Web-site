...
<div class="main">
    ...
    <br>
        <?php
        // select all data
        $query = $mysqli->prepare("SELECT id_list,id_exercise,day,ripetitions,weight,details FROM exercise_list WHERE id_schedule = ? ORDER BY day DESC LIMIT $from_record_num,$records_per_page");
        ...
        if ($result > 0){
            ...
            $query->bind_result($id_list,$id_exercise,$day,$ripetitions,$weight,$details);
            ...
            $statement = mysqli_prepare($mysqli,'SELECT * FROM exercise_list WHERE id_schedule = ? ');
