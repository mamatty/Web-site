        ...
        try{
            ...
            if ($result > 0) {
                ...
                while($row = $query->fetch()){
                    ...
                    $query_ins = $mysqli->prepare("INSERT INTO exercise_list (id_schedule,id_exercise,day,ripetitions,weight,details) VALUES (?,?,?,?,?,?)");
                    $query_ins->bind_param("iiiiis",$id,$id_exercise,$day,$series,$weight,$detail);

                    if ($query_ins->execute() === true) {
