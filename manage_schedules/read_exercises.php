...
<div class="main">
    ...
    <br>
        <?php
        // select all data
        $query = "SELECT * FROM exercise LIMIT $from_record_num,$records_per_page";
        ...
        if (mysqli_num_rows($result)){
            ...
            while ($row = $result->fetch_assoc()){
                ...
                echo "<td>".$row['muscolar_zone']."</td>";
                echo "<td>";

                // we will use this links on next part of this post
                echo "<a href='update_exercise_list.php?id=".$row['id_exercise']."' class='btn btn-primary m-r-1em'>Edit</a>";

                // we will use this links on next part of this post
                echo "<a href='#' onclick='delete_exercise(".$row['id_exercise'].");'  class='btn btn-danger'>Delete</a>";
                echo "</td>";
                echo "</tr>";
            }
            ...
            $statement = mysqli_prepare($mysqli,'SELECT * FROM exercise');
