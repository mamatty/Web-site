...
<div class="main">
    ...
    try {
        ...
        $query1 = $mysqli->prepare("SELECT name, description, muscolar_zone FROM exercise WHERE id_exercise = ? LIMIT 0,1");
        $query1->bind_param('i', $id);
        $query1->execute();
        $query1->store_result();
        $query1->bind_result($name,$description, $muscolar_zone);
    ...
    <table class='table table-hover table-responsive table-bordered'>
        <tr>
            <td>Name</td>
            <td><?php echo htmlspecialchars($name1, ENT_QUOTES);  ?></td>
        </tr>
        <tr>
            <td>Description</td>
            <td><?php echo htmlspecialchars($description1, ENT_QUOTES);  ?></td>
        </tr>
        <tr>
            <td>Muscolar zone</td>
            <td><?php echo htmlspecialchars($muscolar_zone1, ENT_QUOTES);  ?></td>
        </tr>
        <tr>
            <td></td>
            <td>
