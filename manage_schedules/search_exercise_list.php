...
<div class="main">
    ...
    <br>
        ...
        if(isset($_GET['search'])) {
            ...
            // select all data
            $params = $_GET['search'];
            $query = $mysqli->prepare("SELECT id_exercise, name, description, muscolar_zone FROM exercise WHERE  name = ? LIMIT $from_record_num,$records_per_page");
            ...
            if ($result > 0){
                ...
                $query->bind_result($id_exercise,$description, $muscolar_zone, $name );
                while ($row = $query->fetch()){
                    ...
                    echo "</tr>";
                        ...
                        $statement = mysqli_prepare($mysqli, "SELECT * FROM exercise WHERE name = ?");
