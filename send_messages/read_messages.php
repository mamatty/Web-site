...
<!--==============================header=================================-->
    ...
    <br>
        ...
        $query = "SELECT id_message, title, send_date, destination FROM messages ORDER BY send_date DESC LIMIT $from_record_num,$records_per_page";
        ...
        if (mysqli_num_rows($result)){
            ...
            $statement = mysqli_prepare($mysqli,'SELECT * FROM messages');
